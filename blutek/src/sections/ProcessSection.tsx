      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
            Nuestro{" "}
            <span className="text-blue-900">Proceso</span>
          </h2>
              ...
              >
                <div className="relative z-10 mb-4">
                  <motion.div
                    ...
                    className="bg-blue-600 flex size-14 rounded-full items-center justify-center text-white text-xl font-bold shadow-lg"
                  >
